...
class FarmerUpdateProduct extends StatefulWidget {
  ...
  int index;
  FarmerUpdateProduct({super.key,required this.product,required this.index});

  @override
  State<FarmerUpdateProduct> createState() => _FarmerUpdateProductState();
}

class _FarmerUpdateProductState extends State<FarmerUpdateProduct> {
  ...
  void initState() {
    ...
    shortDescriptionController.text = widget.product.description;
    selectedType = widget.product.category;
    super.initState();
  }
  @override
